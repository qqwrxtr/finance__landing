...
const TermsOfService = () => {
    return (
        <div className="terms-of-service flex flex-col items-center px-6 py-10 sm:px-12 lg:px-24 bg-gradient-to-r from-purple-600 via-blue-500 to-indigo-600 text-white min-h-screen">
            ...
            <div className="content w-full max-w-7xl space-y-8 text-left bg-white bg-opacity-10 p-10 rounded-lg">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">Acceptance of Terms</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">1. General Information</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">2. Financial Advice Disclaimer</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">3. Eligibility</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">4. Use of Services</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">5. Third-Party Links and Services</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">6. Limitation of Liability</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">7. Indemnification</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">8. Changes to Terms</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">9. Governing Law and Jurisdiction</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">10. Privacy Policy</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">11. Termination</h2>
                    <p className="text-gray-300 leading-relaxed">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl sm:text-3xl font-bold text-[#f0f0f0]">12. Contact Us</h2>
                    <p className="text-gray-300 leading-relaxed">
